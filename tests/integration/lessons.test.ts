...
it("attendance installs without assessments and its repair is repeatable",async()=>{
 const independent=await createTestDatabase(false,["202609150001_assessments.sql","202609150004_grading_setup.sql","202609150005_grade_submission.sql","202609160001_grade_review.sql","202609160002_grade_locks.sql"]);
 try{
