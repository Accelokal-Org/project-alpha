...
export default function AdminLogin() {
 ...
 return <main className="min-h-screen grid place-items-center p-6"><section className="w-full max-w-md bg-white rounded-lg border border-border p-7 sm:p-9">
  <div className="flex items-center gap-3 mb-8"><Image src="/brand/deskonekt-icon-light-transparent.png" width={404} height={394} alt="" className="w-12 h-auto" sizes="48px" /><div><p className="font-semibold text-xl text-navy">{brand.name}</p><p className="text-xs text-muted">{brand.byline}</p></div></div>
