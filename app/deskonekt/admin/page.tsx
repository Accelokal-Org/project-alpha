...
const tabs=["overview","structure","people","subjects","assignments","accounts","attendance","audit"];
export default async function AdminPage({searchParams}:{searchParams:Promise<{school?:string;tab?:string}>}) {
 ...
 <main id="admin-main" className="max-w-7xl mx-auto p-5 sm:p-8">
  ...
  <p className="text-xs text-muted mt-7">Available now: school setup, role connections, assignments, and rosters. Subject assessments and scoring are available in the teacher workspace. Attendance is available in subject workspaces. Grade workflows and billing will be added later.</p>
 </main></div>;
}
