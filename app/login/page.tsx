...
export default function Login() {
 ...
 return <main className="min-h-screen grid lg:grid-cols-[1fr_1.15fr]">
  <section className="bg-navy text-white px-8 py-12 lg:p-16 flex flex-col justify-between gap-16">
   <Link href="/login" className="flex items-center gap-3 text-xl font-semibold tracking-tight"><BookOpen size={25} className="text-cyan-300" aria-hidden="true" /> {brand.name}</Link>
